...
Пользователь может выбрать продукты как из общего списка продуктов, так и из, заранее собранных, наборов ("Под ситуацию", "Приготовь блюдо"), а так же создавать собственные наборы. Сервис работает с курьерской службой (8 вариантов доставки). Продукты магазина находятся в 4 разных складких отделениях, каждое со своим набором продуктов.
